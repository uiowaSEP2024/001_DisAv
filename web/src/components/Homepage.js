    ...
    <div className="homepage" data-testid="homepage">
      <div className="welcome-section">
        <div className="text">
          ...
          <p className="bio">Rediscover the power of concentration and reclaim your time. Infinite Focus is your digital companion in the quest for productivity, guiding you away from the endless scroll and towards meaningful engagement with your tasks. Whether it's time to stretch, hydrate, or dive into a good book, Infinite Focus gently nudges you back on track. Embrace the full potential of every moment — because your attention is invaluable.</p>
